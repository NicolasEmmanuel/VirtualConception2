        ...
        <div class="container mt-5">
                ...
                <div class="row">
                        <div class="col-xl-12 text-right">
                                <a href="{{route("blog.accueil") }}" class="btn btn-danger"> Back </a>
                        </div>
                </div>

        <form action="{{route('blog.ajout')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                                <div class="form-group">
                                                        <label> Title </label>
                                                        <input type="text" class="form-control" name="titre" placeholder="Enter the Title">
                                                </div>
                                                <div class="form-group">
                                                        <label> Body </label>
