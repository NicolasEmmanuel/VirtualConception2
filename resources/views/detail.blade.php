...
<style>
  ...
  <main class="relative container mx-auto bg-white px-4">
    <div class="relative -mx-4 top-0 pt-[17%] overflow-hidden">
      <img class="absolute inset-0 object-cover object-top w-full h-full filter blur" src="https://upload.chatsdumonde.com/img_global/24-comportement-education-du-chat/_light-1098-chat-chasseur-la-chasse-chez-le-chat.jpg" alt="" />
    </div>
  
    <div class="mt-[-10%] w-1/2 mx-auto">
      <div class="relative pt-[56.25%] overflow-hidden rounded-2xl">
        <img class="w-full h-full absolute inset-0 object-cover" src="https://upload.chatsdumonde.com/img_global/24-comportement-education-du-chat/_light-1098-chat-chasseur-la-chasse-chez-le-chat.jpg" alt="" />
      </div>
    </div>
  
    <article class="max-w-prose mx-auto py-8">
      <h1 class="text-2xl font-bold">{{$detail->description}}</h1>
      <h2 class="mt-2 text-sm text-gray-500">{{$detail->created_at->format( "D M Y")}}</h2>
